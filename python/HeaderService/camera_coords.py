...
"""This modules describe the CCD/Camera coordinate systems as described in LCA-13501"""
#
...
class CCDGeom:
    ...
    def primary(self):
        ...
        self.DATASEC = '[{:d}:{:d},1:{:d}]'.format(self.preh+1,self.preh+self.dimh,self.dimv)
    ...
    def wcs_CCD(self,Sx,Sy):
        ...
        if self.vendor == 'E2V':
            ...
            CRVAL2 = Sx*(self.dimh +1 ) + Sy*self.dimh+(2*Sx - 1)*preh 
            ...
            CRPIX2 = 0
            CRVAL1 = Sx*(2*self.dimv+1)
            CRVAL2 = dimh + 1 + Sy*self.dimh - self.preh
